...
<div class="container-fluid py-2">
    <div class="row">
        <div class="ms-3">
            <h3 class="mb-0 h4 font-weight-bolder">Laundry Dashboard</h3>
            <p class="mb-4">
                Track your daily orders, revenue, and customer activities.
            </p>
        </div>
                ...
                <div class="card">
                    <div class="card-header p-2 ps-3">
                        <div class="d-flex justify-content-between">
                            <div>
                                <p class="text-sm mb-0 text-capitalize">Total Orders (This Month)</p>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <a href="{{ route('reports.revenue') }}" class="text-decoration-none">
                <div class="card">
                    ...
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-2 ps-3">
                        <p class="mb-0 text-sm"><span class="text-success font-weight-bolder">+8% </span>growth</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <a href="{{ route('customers.index') }}" class="text-decoration-none">
                <div class="card">
                    ...
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-2 ps-3">
                        <p class="mb-0 text-sm"><span class="text-success font-weight-bolder">+5 </span>new this week</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <a href="{{ route('orders.index', ['status' => 'pending']) }}" class="text-decoration-none">
                <div class="card">
                    ...
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-2 ps-3">
                        <p class="mb-0 text-sm"><span class="text-danger font-weight-bolder">+10 </span>since yesterday</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-lg-12 col-md-10 mx-auto">
            <div class="card mt-4">
                <div class="card-header p-3">
                    ...
                    <p class="text-sm mb-0">Use the buttons below to quickly navigate to common tasks.</p>
                </div>
