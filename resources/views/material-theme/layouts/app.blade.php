...
<head>
    ...
    <link href="{{ url('material/assets/js/plugins/datatable/css/dataTables.bootstrap5.min.css')}}" rel="stylesheet" />
</head>

<body class="g-sidenav-show  bg-gray-100">

    @include('material-theme.layouts.partials.auth.sidenav')
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        @include('material-theme.layouts.partials.auth.topnav')

        @yield('content')
        @include('material-theme.layouts.partials.auth.footer')
        <!-- </div> -->
    </main>
    ...
    <!--   Core JS Files   -->
    <script src="{{ url('material/assets/js/core/jquery.min.js')}}"></script>
    ...
    <script src="{{ url('material/assets/js/plugins/datatable/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{ url('material/assets/js/plugins/datatable/js/dataTables.bootstrap5.min.js')}}"></script>
